  ...
  return (
    <aside className="min-h-0 overflow-y-auto border-t border-slate-200/70  p-5 dark:border-slate-800/80 lg:border-l lg:border-t-0 lg:p-6">
      <div className="space-y-6 lg:sticky lg:top-0">
        <section className="space-y-3 rounded-3xl border border-slate-200/80 bg-white/90 p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/90">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              {preview.dna.map((item) => (
                <span
                  key={item}
                  className="rounded-full border border-cyan-200 bg-cyan-50 px-3 py-1 text-xs font-medium text-cyan-700 dark:border-cyan-900 dark:bg-cyan-950/60 dark:text-cyan-200"
                >
                  {item}
                </span>
              ))}
