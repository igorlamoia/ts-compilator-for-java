...
export function KeywordCustomizer() {
    ...
    const handleChange = (original: string, value: string) => {
        ...
        setErrors((prev: Record<string, string | null>) => ({ ...prev, [original]: error }));
    };
    ...
    const hasChanges = mappings.some((m: KeywordMapping) => m.original !== m.custom);
    ...
    return (
        ...
        "
                title="Personalizar palavras reservadas"
            >
                <svg
