          ...
          <div className="flex gap-4">
            {isTeacher ? (
              ...
              <button
                ...
                className="group flex items-center justify-center gap-2 px-6 py-3 rounded-xl text-sm font-bold bg-linear-to-r from-[#0dccf2] to-[#10b981] text-[#101f22] shadow-[0_0_20px_rgba(13,204,242,0.3)] hover:shadow-[0_0_30px_rgba(13,204,242,0.5)] hover:scale-[1.02] transition-all duration-300"
              >
                <svg
            ...
            <form onSubmit={handleCreateClass} className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-lg bg-white/5 hover:bg-white/10 text-sm text-slate-300 transition-all"
                >
                  Cancelar
                </button>
                <button
                  type="submit"
                  className="flex-1 py-2.5 rounded-lg bg-linear-to-r from-[#0dccf2] to-[#10b981] text-[#101f22] text-sm font-bold hover:opacity-90 transition-all"
                >
                  Criar Turma
                </button>
              </div>
