...
async function main() {
  const [organizationCount, userCount, classCount, exerciseCount] =
  ...
  const hasAnyData = userCount > 0 || classCount > 0 || exerciseCount > 0;

  if (hasAnyData) {
    console.log("ℹ️ Seed ignorado: banco já contém dados.");
    console.log(
      `   organization=${organizationCount}, user=${userCount}, class=${classCount}, exercise=${exerciseCount}`,
    );
    return;
  }
  ...
  console.log(
    "✅ Usuários criados: Prof. Carlos Silva, Ana Souza, Bruno Oliveira, Camila Ferreira",
  );
  ...
  const classesData = [
    {
      ...
      name: "Programação I",
      description:
        "Introdução à Programação com Java — conceitos básicos, variáveis, condicionais e laços.",
    ...
    },
    {
      ...
      name: "Programação II",
      description:
        "Programação Orientada a Objetos com Java — herança, polimorfismo, interfaces e coleções.",
  ...
  console.log(
    "✅ Turmas criadas: Programação I (PROG1-2025), Programação II (PROG2-2025)",
  );
  ...
  const exercises = [
    {
      ...
      title: "Hello World",
      description:
        'Escreva um programa Java que imprime "Hello World" no console. Este é o seu primeiro programa!',
      attachments: "",
      teacherId: PROFESSOR_ID,
    },
    {
      ...
      description:
        "Leia dois números inteiros da entrada padrão e imprima a soma deles.",
      attachments: "",
      teacherId: PROFESSOR_ID,
    },
    {
      ...
      title: "Par ou Ímpar",
      description:
        'Leia um número inteiro e imprima "PAR" se for par ou "IMPAR" se for ímpar.',
      attachments: "",
      teacherId: PROFESSOR_ID,
    },
    {
      ...
      title: "Fatorial",
      description:
        "Calcule o fatorial de um número inteiro N (N!). Utilize um laço for ou while.",
      attachments: "",
      teacherId: PROFESSOR_ID,
    },
    {
      ...
      description:
        "Crie uma classe Retangulo com atributos largura e altura. Implemente métodos para calcular área e perímetro.",
      attachments: "",
      teacherId: PROFESSOR_ID,
    },
    {
      ...
      description:
        "Crie uma classe base Animal com o método emitirSom(). Crie as subclasses Cachorro e Gato que sobrescrevem o método.",
      attachments: "",
      teacherId: PROFESSOR_ID,
    },
  ];
  ...
  const lists = [
    {
      ...
      description:
        "Exercícios básicos de Java: Hello World, soma, condicionais e laços.",
      teacherId: PROFESSOR_ID,
    },
    {
      id: LIST2_ID,
      title: "Lista 2 — POO",
      description:
        "Exercícios de Programação Orientada a Objetos: classes, herança e polimorfismo.",
      teacherId: PROFESSOR_ID,
    },
  ];
